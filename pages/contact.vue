      ...
      <form ref="contactForm" name="contact-form" action="https://kwesforms.com/api/foreign/forms/90oV3Vjk6J261C8jDRU7" class="grid grid-cols-1 gap-y-4 max-w-md w-full content-start px-3 sm:px-0 flex-grow bg-gray-100 pb-24 kwes-form" has-recaptcha-v2>
        ...
        <label class="block">
          ...
          <div class="relative mt-1" style="width: 304px; height: 76px">
            <div class="loading-captcha absolute top-0 left-0 inset-x-0.5 flex justify-center items-center text-sm text-gray-700 h-full border rounded">Loading...</div>
            <recaptcha class="g-recaptcha absolute top-0 left-0 w-max" />
          </div>
        </label>

        <button type="submit" value="Send" class="bg-blue-500 hover:bg-blue-400 px-5 py-2.5 rounded-sm uppercase text-sm font-bold text-white border-t border-blue-300 hover:border-blue-200 shadow-sm tracking-wide w-max cursor-pointer mt-4">Send</button>
      </form>
